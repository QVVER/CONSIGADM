...
<nav>
  ...
  <ul class="sidenav" id="mobile-demo">
    ...
    <br>
        ...
        <h1>Menu Usuários</h1>
        <a href="cadastrar-usuario.php" class="btn black"> Cadastrar usuário</a>
            <a href="consultar-usuario.php" class="btn black "> Consultar usuário</a>
