...
$id = $_POST["id"]; //veio pelo input hidden
$nome = $_POST["nome"];
...
$nomebonus = $nome."-BONUS.".$ext5;
  ...
  $sql = "UPDATE arquivosoperacional set nome='".$nome."', arquivorg='".$nomerg."', arquivocpf='".$nomecpf."', res ='".$nomeresidencia."'  , contrato ='".$nomecontrato."', cc ='".$nomecontracheque."', intencionamento ='".$nomebonus."' where id='".$id."'";
...
if( mysqli_query($con, $sql)){
   ...
   if(!is_dir("docs-clientes/".$folder)){
    ...
    $msg = "Arquivos atualizados! Por favor, acompanhe seu contrato.";
