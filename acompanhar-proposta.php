  ...
  <ul class="sidenav" id="mobile-demo">
    ...
    <li><a href="mobile.html">Mobile</a></li>
            ...
            <a href="menu.php" class="btn red">Voltar</a>
                ...
                <h3> Acompanhamento de proposta</h3>
                ...
                while($produto = mysqli_fetch_array($produtos)){
                   ...
                   if($status['0'] == "Em andamento"){
                    ...
                    ?>
                    <form action="editar-proposta.php" METHOD="GET">
            <div class="row">
                <div class="col s2">
                    ...
                    <p id='data' <?php echo $cor; ?>><font size="1"  > <?php echo $status['0']; ?></font></p>
                </div>
            </div>
                    ...
                    <div class="row" style="margin-left: 680px; margin-top: -5px;">
