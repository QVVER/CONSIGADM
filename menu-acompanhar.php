...
<nav>
  ...
  <ul class="sidenav" id="mobile-demo">
    ...
    <br>
        ...
        <h1>Menu Acompanhar</h1>
        <a href="acompanhar-consultor.php" class="btn" >Consultores</a>
        <a href="acompanhar-equipe.php" class="btn" >Equipe</a>
        <a href="limpar-visitas.php" class="btn black">Higienizar visitas, metas e produção</a>
